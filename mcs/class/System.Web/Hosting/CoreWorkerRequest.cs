...
namespace System.Web.Hosting {
    ...
    //
    // An offshoot of SimpleWorkerRequest that will less restrictive.
    //
    ...
    /// </devdoc>
    [ComVisible(false)]
    public class CoreWorkerRequest : HttpWorkerRequest {
        ...
        private void ExtractPagePathInfo() {
            int pathIndex = _page.IndexOf('/');
            int pageIndex = _page.LastIndexOf('/');

            if (pathIndex >= 0) {
                _pathInfo = _page.Substring(pathIndex);
            }

            if (pageIndex >= 0) {
                _page = _page.Substring(pageIndex + 1);
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public CoreWorkerRequest(String page, String query, TextWriter output): this() {
            _queryString = query;
            _output = output;
            _page = page;
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public CoreWorkerRequest(String appVirtualDir, String appPhysicalDir, String page, String query, TextWriter output): this() {
