    ...
    public class SqlMembershipProvider : MembershipProvider
    {
        ...
        public override string ApplicationName
        {
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                    throw System.Web.Util.ExceptionUtil.PropertyNullOrEmpty("ApplicationName");
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"])) {
                ...
                config.Add("description", System.Web.SR.GetString(System.Web.SR.MembershipSqlProvider_description));
            }
            ...
            case "Hashed":
                ...
                break;
            default:
                throw new ProviderException(System.Web.SR.GetString(System.Web.SR.Provider_bad_password_format));
            }

            if (PasswordFormat == MembershipPasswordFormat.Hashed && EnablePasswordRetrieval)
                throw new ProviderException(System.Web.SR.GetString(System.Web.SR.Provider_can_not_retrieve_hashed_password));
            //if (_PasswordFormat == MembershipPasswordFormat.Encrypted && MachineKeySection.IsDecryptionKeyAutogenerated)
            //    throw new ProviderException(System.Web.SR.GetString(System.Web.SR.Can_not_use_encrypted_passwords_with_autogen_keys));
        ...
        public override string GetPassword(string username, string passwordAnswer)
        {
            ...
            {
                throw new NotSupportedException( System.Web.SR.GetString(System.Web.SR.Membership_PasswordRetrieval_not_supported)  );
            }
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            if ( pass.Length > 128 )
            {
                throw new ArgumentException(System.Web.SR.GetString(System.Web.SR.Membership_password_too_long), "newPassword");
            }
        ...
        public override MembershipUser GetUser( object providerUserKey, bool userIsOnline )
        {
            ...
            if ( !( providerUserKey is Guid ) )
            {
                throw new ArgumentException( System.Web.SR.GetString(System.Web.SR.Membership_InvalidProviderUserKey) , "providerUserKey" );
            }
        ...
        internal static string GetExceptionText(int status) {
            ...
            case 0:
                return String.Empty;
            case 1:
                key = System.Web.SR.Membership_UserNotFound;
                break;
            case 2:
                key = System.Web.SR.Membership_WrongPassword;
                break;
            case 3:
                key = System.Web.SR.Membership_WrongAnswer;
                break;
            case 4:
                key = System.Web.SR.Membership_InvalidPassword;
                break;
            case 5:
                key = System.Web.SR.Membership_InvalidQuestion;
                break;
            case 6:
                key = System.Web.SR.Membership_InvalidAnswer;
                break;
            case 7:
                key = System.Web.SR.Membership_InvalidEmail;
                break;
            case 99:
                key = System.Web.SR.Membership_AccountLockOut;
                break;
            default:
                key = System.Web.SR.Provider_Error;
                break;
            }
            return System.Web.SR.GetString(key);
        }
        ...
        private string UnEncodePassword(string pass, int passwordFormat)
        {
            switch (passwordFormat)
            {
                ...
                case 1: // MembershipPasswordFormat.Hashed:
                    throw new ProviderException(System.Web.SR.GetString(System.Web.SR.Provider_can_not_decode_hashed_password));
                default:
